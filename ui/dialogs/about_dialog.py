...
class AboutDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(f"MediaSorterPAAK {get_full_version_string()}")  # 창의 제목에 버전 표시
        ...
        description = QLabel(
            "MediaSorterPAAK is a powerful file organization tool designed to help you "
        ...
        links_detail = QLabel(
            '• <a href="https://github.com/htpaak/MediaSorterPAAK">GitHub Repository</a><br>'
            '• <a href="https://github.com/htpaak/MediaSorterPAAK/releases/latest">Download Latest Version</a><br>'
            '• <a href="https://github.com/htpaak/MediaSorterPAAK/discussions">Feedback</a>'
        )
